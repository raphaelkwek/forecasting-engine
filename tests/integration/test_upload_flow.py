...
SIGNALS_CSV = (
    ...
    b"2026-01-02,4750.5,102.3,13.2,4.15,103.7,10.1,1.05,3.41,2.3,8.4,2.25,12.5,0.05,0.02,0.01,0.02,0.01,0.01\n"
    b"2026-01-05,4762.1,102.1,12.9,4.18,104.1,10.3,1.03,3.38,2.4,8.3,2.28,12.3,0.02,0.01,0.02,0.01,0.01,0.01\n"
    b"2026-01-06,4739.8,102.6,14.1,4.22,103.5,10.5,1.08,3.55,2.5,8.9,2.30,12.8,0.01,0.03,0.01,0.02,0.01,0.01\n"
)
...
def test_the_parsed_frame_carries_every_column_through(in_a_scratch_workspace):
    ...
    assert len(accepted.frame.columns) == 19
...
@pytest.mark.parametrize(
    ...
    ids=["book.xlsx", "disguised.csv", "huge.csv"],
)
